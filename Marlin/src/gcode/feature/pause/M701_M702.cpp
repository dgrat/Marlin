...
void GcodeSuite::M701() {
  ...
  // Lift Z axis
  if (park_point.z > 0)
    do_blocking_move_to_z(smaller(current_position[Z_AXIS] + park_point.z, Z_MAX_POS), NOZZLE_PARK_Z_FEEDRATE);
  ...
  // Restore Z axis
  if (park_point.z > 0)
    do_blocking_move_to_z(bigger(current_position[Z_AXIS] - park_point.z, 0), NOZZLE_PARK_Z_FEEDRATE);
