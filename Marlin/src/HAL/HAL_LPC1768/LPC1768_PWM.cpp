...
////  direct control PWM code
  switch (pin) {
    case P1_23:                                       // MKS Sbase Servo 0, PWM1 channel 4  (J3-8 PWM1.4)
      ...
      direct_table[P1_23_PWM_channel - 1].max = smaller(max, LPC_PWM1_MR0 - MR0_MARGIN);
    ...
    case P1_20:                                       // Servo 0, PWM1 channel 2  (Pin 11  P1.20 PWM1.2)
      ...
      direct_table[P1_20_PWM_channel - 1].max = smaller(max, LPC_PWM1_MR0 - MR0_MARGIN);
    ...
    case P1_21:                                       // Servo 1, PWM1 channel 3  (Pin 6  P1.21 PWM1.3)
      ...
      direct_table[P1_21_PWM_channel - 1].max = smaller(max, LPC_PWM1_MR0 - MR0_MARGIN);
    ...
    case P1_18:                                       // Servo 3, PWM1 channel 1 (Pin 4  P1.18 PWM1.1)
      ...
      direct_table[P1_18_PWM_channel - 1].max = smaller(max, LPC_PWM1_MR0 - MR0_MARGIN);
    ...
    case P2_04:                                       // D9 FET, PWM1 channel 5  (Pin 9  P2_04 PWM1.5)
      ...
      direct_table[P2_04_PWM_channel - 1].max = smaller(max, LPC_PWM1_MR0 - MR0_MARGIN);
    ...
    case P2_05:                                       // D10 FET, PWM1 channel 6 (Pin 10  P2_05 PWM1.6)
      ...
      direct_table[P2_05_PWM_channel - 1].max = smaller(max, LPC_PWM1_MR0 - MR0_MARGIN);
...
////  direct control PWM code
  switch (pin) {
    case P1_23:                                                           // MKS Sbase Servo 0, PWM1 channel 4  (J3-8 PWM1.4)
      ...
      LPC_PWM1->MR4 = bigger(smaller(value, direct_table[P1_23_PWM_channel - 1].max), direct_table[P1_23_PWM_channel - 1].min);
    ...
    case P1_20:                                                           // Servo 0, PWM1 channel 2 (Pin 11  P1.20 PWM1.2)
      ...
      // load the new time value
      LPC_PWM1->MR2 = bigger(smaller(value, direct_table[P1_20_PWM_channel - 1].max), direct_table[P1_20_PWM_channel - 1].min);
    ...
    case P1_21:                                                           // Servo 1, PWM1 channel 3 (Pin 6  P1.21 PWM1.3)
      ...
      // load the new time value
      LPC_PWM1->MR3 = bigger(smaller(value, direct_table[P1_21_PWM_channel - 1].max), direct_table[P1_21_PWM_channel - 1].min);
    ...
    case P1_18:                                                           // Servo 3, PWM1 channel 1 (Pin 4  P1.18 PWM1.1)
      ...
      // load the new time value
      LPC_PWM1->MR1 = bigger(smaller(value, direct_table[P1_18_PWM_channel - 1].max), direct_table[P1_18_PWM_channel - 1].min);
    ...
    case P2_04:                                                           // D9 FET, PWM1 channel 5 (Pin 9  P2_04 PWM1.5)
      ...
      // load the new time value
      LPC_PWM1->MR5 = bigger(smaller(value, direct_table[P2_04_PWM_channel - 1].max), direct_table[P2_04_PWM_channel - 1].min);
    ...
    case P2_05:                                                           // D10 FET, PWM1 channel 6 (Pin 10  P2_05 PWM1.6)
      ...
      // load the new time value
      LPC_PWM1->MR6 = bigger(smaller(value, direct_table[P2_05_PWM_channel - 1].max), direct_table[P2_05_PWM_channel - 1].min);
...
////  interrupt controlled PWM code
  ...
  work_table[slot].microseconds = bigger(smaller(value, work_table[slot].max), work_table[slot].min);;
...
HAL_PWM_TIMER_ISR {
  ...
  HAL_PWM_TIMER->MR1 = bigger(next_MR1_val, HAL_PWM_TIMER->TC + PWM_LPC1768_ISR_SAFETY_FACTOR); // set next
  in_PWM_isr = false;
