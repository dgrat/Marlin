...
void HAL_timer_start(const uint8_t timer_num, const uint32_t frequency) {
  ...
  switch (timer_num) {
    case STEP_TIMER_NUM:
      ...
      timer_set_compare(STEP_TIMER_DEV, STEP_TIMER_CHAN, smaller(HAL_TIMER_TYPE_MAX, (STEPPER_TIMER_RATE / frequency)));
    ...
    case TEMP_TIMER_NUM:
      ...
      timer_set_compare(TEMP_TIMER_DEV, TEMP_TIMER_CHAN, smaller(HAL_TIMER_TYPE_MAX, ((F_CPU / TEMP_TIMER_PRESCALE) / frequency)));
