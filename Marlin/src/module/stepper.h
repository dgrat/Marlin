...
#define _MIN_STEPPER_PULSE_CYCLES(N) bigger((unsigned long)((F_CPU) / (MAXIMUM_STEPPER_RATE)), ((F_CPU) / 500000UL) * (N))
#if MINIMUM_STEPPER_PULSE
...
#define ISR_LOOP_CYCLES (ISR_LOOP_BASE_CYCLES + bigger(MIN_STEPPER_PULSE_CYCLES, MIN_ISR_LOOP_CYCLES))
...
// If linear advance is enabled, then it is handled separately
  ...
  #define ISR_LA_LOOP_CYCLES bigger(MIN_STEPPER_PULSE_CYCLES, MIN_ISR_LA_LOOP_CYCLES)
