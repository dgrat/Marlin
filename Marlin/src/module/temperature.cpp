...
void Temperature::manage_heater() {
  ...
  #if ENABLED(HEATER_0_USES_MAX6675)
    if (current_temperature[0] > smaller(HEATER_0_MAXTEMP, MAX6675_TMAX - 1.0)) max_temp_error(0);
    if (current_temperature[0] < bigger(HEATER_0_MINTEMP, MAX6675_TMIN + .01)) min_temp_error(0);
  #endif
